                    ...
                    <div className="container">
                        <div className="dz-topbar-inner d-flex justify-content-between align-items-center">
                            <div className="dz-topbar-left">
                                <ul>
                                    <li>Welcome to Pixel Burst Coding Labs</li>
                                    <li>
                                        <Link to={"#"} className="badge badge-primary btn-success" data-bs-toggle="modal" data-bs-target="#modalLogin" 
                            ...
                            <div className="dz-topbar-right">
                                <ul>
                                    <li><i className="fas fa-map-marker-alt"></i><b>289-681-2027</b></li>
                                    <li><i className="fas fa-envelope"></i>rmp.prog.sa@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
